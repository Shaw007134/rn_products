      ...
      <ScrollView
          ...
          <TouchableOpacity
            ...
            <View style={{flex: 2, justifyContent: 'space-around'}}>
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <Text style={{color: '#fff', marginLeft: pxToDp(5)}}>
                  {city}
                </Text>
              </View>
            </View>
        ...
        <View style={{marginTop: pxToDp(15)}}>
          <ListItem
            leftIcon={
              <IconFont
                style={{color: 'green', fontSize: pxToDp(20)}}
                name="icondongtai"
              />
            }
            title="我的动态"
          ...
          <ListItem
            leftIcon={
              <IconFont
                style={{color: 'red', fontSize: pxToDp(20)}}
                name="iconshuikanguowo"
              />
            }
            title="谁看过我"
            titleStyle={{color: '#666'}}
          ...
          <ListItem
            leftIcon={
              <IconFont
                style={{color: 'purple', fontSize: pxToDp(20)}}
                name="iconshezhi"
              />
            }
            title="通用设置"
          ...
          <ListItem
            leftIcon={
              <IconFont
                style={{color: 'blue', fontSize: pxToDp(20)}}
                name="iconkefu"
              />
            }
            title="客服在线"
